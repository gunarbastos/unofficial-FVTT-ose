import {PolymorphicDataType} from "./polymorphicDataType.js"
import {EffectDataModel} from "./effectDataModel.js"
import {DamageEffectDataModel} from "./effects/index.js"
    ...
    static defineSchema() {
        ...
        return {
            ...
            effects: new fields.ArrayField(/** @type any*/ new PolymorphicEmbeddedField(
                EffectDataModel,
                {
                    [DamageEffectDataModel.type]: DamageEffectDataModel,
                },
