...
import {AbilityDataModel, SavesDataModel} from "../index.js"; //BaseItemDataModel
...
function _commonAttributes() {
    return {
        ...
        levels: new fields.ArrayField(new fields.SchemaField({
            ...
            save: new fields.EmbeddedDataField(SavesDataModel),
...
export class EmbedClassDataModel extends EmbedBaseItemDataModel {
