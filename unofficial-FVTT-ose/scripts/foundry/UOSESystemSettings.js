    ...
    _buildDefinitions() {
        return {
            ...
            languages: {
                ...
                config: false,
                type: Array,
                default: ['Common', 'Lawful', 'Neutral', 'Evil', 'Bugbear', 'Doppelganger', 'Dragon', 'Dwarvish', 'Elvish', 'Gargoyle', 'Gnoll', 'Gnomish', 'Goblin', 'Halfling', 'Harpy', 'Hobgoblin',
            ...
            encumbrance: {
                ...
                config: false,
                type: String,
                options: [{value: 'Disabled'}, {value: 'Basic'}, {value: 'Detailed'}, {
                    value: 'Item',
